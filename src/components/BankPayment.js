            ...
            <Col>
              ...
              >
                ...
                <div className="" style={{ display: "flex", justifyContent:"space-around",flexDirection:"row", paddingLeft:5 }}>
                  <img className="img-fluid" src={data.imgUrl} width={90} />
                </div>
              </div>
            </Form.Check>
            </Col>
          ...
          <div className="box-outer">
            <div className="box-inner">
              <div className="text-center mb-3">
                ...
                <RWebShare
                  data={{
                    text: `Account Name: ${bankDetails.AcName} \n\n Account Number: ${bankDetails.acNum} \n\n IFSC code: ${bankDetails.ifsc} \n\n Bank branch: ${bankDetails.branch} \n\n GST number: ${bankDetails.gstNum}`,
                    
                    title: "SKYGOAL PAYMENT",
                  }}
                  onClick={() => success_notify("shared successfully!")}
                >
                  <FaShareAlt
              ...
              <Form>
                ...
                <Form.Group className="mb-3">
                  ...
                  <InputGroup className="mb-3 ">
                    ...
                    >
                      <CopyToClipboard
                        text={bankDetails?.AcName}
                        onCopy={() =>
                          success_notify("Copied Successfully !", 3000)
                        }
                      >
                        <span>
                          <div>
